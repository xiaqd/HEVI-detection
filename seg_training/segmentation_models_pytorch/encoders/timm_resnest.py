...
resnest_weights = {
    'timm-resnest14d': {
        ...
        'histology': 'path/to/pretrain_model'
    },
    'timm-resnest26d': {
...
pretrained_data_setting = {}

pretrained_data_setting['imagenet'] = {
                                        # "url": source_url,
...
pretrained_data_setting['histology'] = {
                                        # "url": source_url,
                                        'input_size': [3, 200, 200],
                                        'input_range': [0, 1],
                                        'mean': [0.813, 0.634, 0.733],
                                        'std': [0.091, 0.145, 0.108],
                                        'num_classes': 2
                                       }
...
for model_name, sources in resnest_weights.items():
    ...
    for source_name, source_url in sources.items():
        pretrained_settings[model_name][source_name] = pretrained_data_setting[source_name]
        pretrained_settings[model_name][source_name].update({'url': source_url})
